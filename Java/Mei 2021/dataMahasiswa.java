      ...
      System.out.print(
        ...
        switch (pilihan) {
          case 1:
            ...
            pilihan2 = in.nextInt();
            switch (pilihan2) {
              case 1: prodi = "Agroteknologi"; valid = true; break;
              case 2: prodi = "Agribisnis"; valid = true; break;
              default:
               clear();
          ...
          case 2:
            ...
            pilihan2 = in.nextInt();
            switch (pilihan2) {
              case 1: prodi = "Pendidikan Geografi"; valid = true; break;
              case 2: prodi = "Pendidikan Bahasa dan Sastra Indonesia"; valid = true; break;
              case 3: prodi = "Pendidikan Bahasa Inggris"; valid = true; break;
              case 4: prodi = "Pendidikan IPS"; valid = true; break;
              default:
                clear();
                System.out.println("Pilihan tidak valid. Masukkan pilihan dengan benar!");
                inputFakultas();
          ...
          case 3:
            ...
            pilihan2 = in.nextInt();
            switch (pilihan2) {
              case 1: prodi = "Teknik Informatika"; valid = true; break;
              case 2: prodi = "Sistem Informasi"; valid = true; break;
              default:
                clear();
                System.out.println("Pilihan tidak valid. Masukkan pilihan dengan benar!");
                inputFakultas();
